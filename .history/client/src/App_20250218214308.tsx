...
function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-background border-t flex justify-around items-center h-16 px-4">
      ...
      <Link href="/profile">
        <a className={cn("flex flex-col items-center", location === "/profile" && "transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 bg-gray-500")}>
          <User size={24} />
